...
from agent.SLO_Registry import SLO_Registry, SLO, calculate_slo_fulfillment, to_avg_SLO_F
...
class TestSLO_Registry(TestCase):
    ...
    def test_to_avg_slo_f(self):
        ...
        self.assertEqual(2.475 / 3, to_avg_SLO_F(slo_f_qr_1))
        self.assertEqual(3.0 / 3, to_avg_SLO_F(slo_f_qr_2))
        self.assertEqual(2.3 / 3, to_avg_SLO_F(slo_f_cv_1))
        self.assertEqual(2.5 / 3, to_avg_SLO_F(slo_f_cv_2))
