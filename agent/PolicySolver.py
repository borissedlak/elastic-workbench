...
if __name__ == '__main__':
    cpd_1 = LinearGaussianCPD(variable='avg_p_latency', evidence=['cores', 'model_size'], beta=[34.512, -7.509, 41.19], std=740.654)

    parameter_bounds = [{'es_type': EsType.RESOURCE_SCALE, 'max': 8, 'min': 1, 'name': 'cores'}, {'es_type': EsType.MODEL_SCALE, 'max': 2, 'min': 1, 'name': 'model_size'}]
    ...
    print(solve(parameter_bounds, linear_relation, clients_slos, 500, True))
